...
public class GamePanel extends JPanel {
    ...
    private void setupUI() {
        ...
        setBackground(Color.decode("#0a0e27"));
        
        cardLayout = new CardLayout();
        cardPanel = new JPanel(cardLayout);
        cardPanel.setBackground(Color.decode("#0a0e27"));
        
        // Hero Selection Screen (ENHANCED)
        ...
        battleScreen.setBackground(Color.decode("#0a0e27"));
    ...
    private JPanel createHeroSelectionScreenEnhanced() {
        heroSelectionPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(
                    0, 0, new Color(10, 14, 39),
                    0, getHeight(), new Color(25, 35, 70)
                );
                g2.setPaint(gradient);
                g2.fillRect(0, 0, getWidth(), getHeight());
                
                // Animated diagonal accent lines
                g2.setColor(new Color(100, 150, 255, 20));
        ...
        statusLabelHero.setFont(new Font("Monospaced", Font.BOLD, 32));
        statusLabelHero.setForeground(new Color(100, 200, 255));
    ...
    private JPanel createHeroImageFrame() {
        JPanel framePanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint borderGradient = new GradientPaint(
                    0, 0, new Color(100, 200, 255, 60),
                    width, height, new Color(200, 100, 255, 60)
                );
        ...
        imageLabelHero.setBackground(new Color(20, 30, 60));
    ...
    private JPanel createStatsAndInfoPanel() {
        ...
        heroIdLabel = new JLabel("ID: H01");
        heroIdLabel.setFont(new Font("Monospaced", Font.PLAIN, 12));
        heroIdLabel.setForeground(new Color(150, 150, 200));
        
        heroNameLabel = new JLabel("Hero Name");
        heroNameLabel.setFont(new Font("Monospaced", Font.BOLD, 28));
        heroNameLabel.setForeground(new Color(100, 200, 255));
        
        namePanel.add(heroIdLabel);
    ...
    private JPanel createEnhancedStatsPanel() {
        ...
        mainStatsPanel.add(createStatCardEnhanced("MP", mpLabel, new Color(50, 150, 255)));
        mainStatsPanel.add(createStatCardEnhanced("ATK", atkLabel, new Color(255, 100, 50)));
        mainStatsPanel.add(createStatCardEnhanced("DEF", defLabel, new Color(200, 200, 50)));
        ...
        cdTitleLabel.setFont(new Font("Monospaced", Font.BOLD, 12));
        cdTitleLabel.setForeground(new Color(150, 150, 200));
        ...
        cdPanel.add(createCooldownBadge("Skill1 (F)", cd1Label, new Color(100, 200, 255)));
        cdPanel.add(createCooldownBadge("Skill2 (S)", cd2Label, new Color(200, 100, 255)));
        cdPanel.add(createCooldownBadge("Ultimate (U)", cdUltLabel, new Color(255, 150, 50)));
    ...
    private JPanel createCooldownBadge(String title, JLabel cdLabel, Color color) {
        ...
        JLabel titleLabel = new JLabel(title);
        titleLabel.setFont(new Font("Monospaced", Font.BOLD, 9));
        titleLabel.setForeground(color);
        titleLabel.setAlignmentX(JLabel.CENTER_ALIGNMENT);
        
        cdLabel.setFont(new Font("Monospaced", Font.BOLD, 18));
        cdLabel.setForeground(new Color(255, 255, 255));
    ...
    private JPanel createEnhancedNavigationPanel() {
        ...
        // Left navigation
        JButton prevButton = createModernButton("◀ PREVIOUS", new Color(100, 150, 255));
        ...
        // Right navigation
        JButton nextButton = createModernButton("NEXT ▶", new Color(100, 150, 255));
        ...
        // Back button
        JButton backBtn = createModernButton("⬅ BACK", new Color(200, 100, 100));
    ...
    private void selectCurrentHero() {
        ...
        if (selectedTeam.size() == 2) {
            ...
            int startLevel = mainApp.getDb().loadCheckpoint(mainApp.getCurrentUserId());
            if (startLevel == 0) startLevel = 1;
            
            startBattle(selectedTeam, startLevel);
        }
    }
        ...
        try {
            ...
            if (heroImageUrl != null && !heroImageUrl.isEmpty()) {
                ...
                if (heroResourceUrl != null) {
                    ...
                    heroImage = heroIcon.getImage().getScaledInstance(100, 200, Image.SCALE_SMOOTH);
            ...
            URL bgResourceUrl = loadAssets("assets/bacgroundbattle.png");
    ...
    private JPanel createBattleScreen() {
        ...
        screen.setBackground(Color.decode("#0a0e27"));
        ...
        bottomPanel.setBackground(Color.decode("#0a0e27"));
        bottomPanel.setBorder(BorderFactory.createMatteBorder(2, 0, 0, 0, Color.WHITE));
        bottomPanel.setPreferredSize(new Dimension(BATTLE_WIDTH, 150));
        
        battleLogArea = new JTextArea();
        battleLogArea.setEditable(false);
        battleLogArea.setFont(new Font("Monospaced", Font.PLAIN, 11));
        ...
        logScroll.setBorder(BorderFactory.createLineBorder(Color.ORANGE, 1));
        ...
        turnInfoLabel.setForeground(Color.decode("#00BFFF"));
        turnInfoLabel.setFont(new Font("Monospaced", Font.BOLD, 12));
        
        JPanel infoPanel = new JPanel(new BorderLayout());
        infoPanel.setBackground(Color.decode("#0a0e27"));
    ...
    private JPanel createSkillButtonsPanel() {
        ...
        panel.setBackground(Color.decode("#0a0e27"));
        panel.setPreferredSize(new Dimension(BATTLE_WIDTH * 2 / 3, 140));
        
        panel.add(createSkillButton("BASIC\nATTACK", "basic", 0, 0, 140, 60));
        panel.add(createSkillButton("ULTIMATE\n" + activeHero.baseCooldowns.get("Ultimate") + "s", "ultimate", 
            activeHero.baseCooldowns.get("Ultimate"), activeHero.skillCooldowns.get("Ultimate"), 120, 60));
        panel.add(createSkillButton("SKILL2\n" + activeHero.baseCooldowns.get("Skill2") + "s", "skill2",
            activeHero.baseCooldowns.get("Skill2"), activeHero.skillCooldowns.get("Skill2"), 120, 60));
        panel.add(createSkillButton("SKILL1\n" + activeHero.baseCooldowns.get("Skill1") + "s", "skill1",
            activeHero.baseCooldowns.get("Skill1"), activeHero.skillCooldowns.get("Skill1"), 120, 60));
        
        panel.add(createSkillButton("E\nEXCHANGE", "exchange", 0, 0, 80, 60));
        panel.add(createSkillButton("H\nREGEN HP", "regenHp",
            activeHero.baseCooldowns.get("RegenHp"), activeHero.skillCooldowns.get("RegenHp"), 80, 60));
        panel.add(createSkillButton("M\nREGEN MP", "regenMp",
            activeHero.baseCooldowns.get("RegenMp"), activeHero.skillCooldowns.get("RegenMp"), 80, 60));
        panel.add(createSkillButton("A\nAWAKENING", "awakening",
    ...
    private void drawBattleScene(Graphics2D g2) {
        ...
        if (heroImage != null) {
            g2.drawImage(heroImage, 80, height - 300, 100, 200, null);
        }
    ...
    private void refreshSkillButtons() {
        if (skillButtonPanel != null) {
            ...
            skillButtonPanel.add(createSkillButton("BASIC\nATTACK", "basic", 0, 0, 140, 60));
            skillButtonPanel.add(createSkillButton("ULTIMATE\n" + activeHero.baseCooldowns.get("Ultimate") + "s", "ultimate",
                activeHero.baseCooldowns.get("Ultimate"), activeHero.skillCooldowns.get("Ultimate"), 120, 60));
            skillButtonPanel.add(createSkillButton("SKILL2\n" + activeHero.baseCooldowns.get("Skill2") + "s", "skill2",
                activeHero.baseCooldowns.get("Skill2"), activeHero.skillCooldowns.get("Skill2"), 120, 60));
            skillButtonPanel.add(createSkillButton("SKILL1\n" + activeHero.baseCooldowns.get("Skill1") + "s", "skill1",
                activeHero.baseCooldowns.get("Skill1"), activeHero.skillCooldowns.get("Skill1"), 120, 60));
            
            skillButtonPanel.add(createSkillButton("E\nEXCHANGE", "exchange", 0, 0, 80, 60));
            skillButtonPanel.add(createSkillButton("H\nREGEN HP", "regenHp",
                activeHero.baseCooldowns.get("RegenHp"), activeHero.skillCooldowns.get("RegenHp"), 80, 60));
            skillButtonPanel.add(createSkillButton("M\nREGEN MP", "regenMp",
                activeHero.baseCooldowns.get("RegenMp"), activeHero.skillCooldowns.get("RegenMp"), 80, 60));
            skillButtonPanel.add(createSkillButton("A\nAWAKENING", "awakening",
                activeHero.baseCooldowns.get("Awakening"), activeHero.skillCooldowns.get("Awakening"), 80, 60));
    ...
    private void showNextLevelDialog() {
        ...
        int nextLevel = mainApp.getCurrentBossLevel() + 1;
        ...
        if (choice == JOptionPane.YES_OPTION) {
            mainApp.getDb().saveCheckpoint(mainApp.getCurrentUserId(), nextLevel);
